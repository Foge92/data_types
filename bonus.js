...
let frase = "stack cats";
frase1 = frase.toLowerCase().match(/[a-z]/gi); //Divide los caracteres de la cadena y solo deja los valores de la a a la z
//console.log(frase1); linea para verificar que la frase1 haga lo que debe hacer 
frase2 = frase.toLowerCase().match(/[a-z]/gi).reverse();//Divide los caracteres de la cadena, solo deja los valores de la a a la z y la escribe de reversa
//console.log(frase2); linea para verificar que la 2 haga lo que debe hacer 

if( frase1.join('') === frase2.join('') ){
